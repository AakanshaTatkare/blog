...
export default function Footer() {
  return (
    ...
    <footer className=' left-0 bg-white w-full '>
      <div className='  flex items-center flex-col sm:flex-row py-8 bg-slate-400  '>
      <a href="" className='flex item-center justify-center md:justify-start '> 
      <span><h6 id="header" className="text-lg font-light tracking-widest  underline decoration-green-1000 text-slate-600 underline-offset-4 ml-7 ">
                            BLOGGERS
                        </h6></span>
      </a>
